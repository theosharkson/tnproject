...
@section('content')
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li><a href="{{route('extras.create')}}">Extras</a></li>
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-danger add-shadow" data-sortable-id="form-stuff-1">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Modify Extra</h4>
                </div>
                <div class="panel-body">
                    <form action="{{route('extras.update',['extra'=>$extra->id])}}" class="form-horizontal" method="POST" enctype="multipart/form-data"
                    onsubmit="return confirm('Are you sure you want to proceed ?');">
                        ...
                        @if($extra->image)
                            <div class="form-group">
                                <img class="center-img"  src="{{route('extras.images.thumb',['image'=>$extra->image]) }}">
                            </div> 
                        @endif
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <input type="text" 
                                    ...
                                    name="name" 
                                    value="{{old('name')?old('name'):$extra->name}}">
                        ...
                        <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">                                            
                                    ...
                                    name="price" 
                                    class="form-control" 
                                    value="{{old('price')?old('price'):$extra->price}}" 
                        ...
                        <div class="form-group{{ $errors->has('price_d') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">                                            
                                    ...
                                    name="price_d" 
                                    class="form-control" 
                                    value="{{old('price_d')?old('price_d'):$extra->price_d}}" 
                        ...
                        <div class="form-group{{ $errors->has('price_coin') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">                                            
                                    ...
                                    name="price_coin" 
                                    class="form-control" 
                                    value="{{old('price_coin')?old('price_coin'):$extra->price_coin}}" 
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="description" rows="10">{{old('description')?old('description'):$extra->description}}</textarea>
