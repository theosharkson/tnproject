...
<!-- Plugins -->
<link rel="stylesheet" type="text/css" href="site-assets/css/plugins-css.css" />

<!-- revoluation -->
<link rel="stylesheet" type="text/css" href="site-assets/revolution/css/settings.css" media="screen" />

<!-- Typography -->
<link rel="stylesheet" type="text/css" href="site-assets/css/typography.css" />

<!-- Shortcodes -->
<link rel="stylesheet" type="text/css" href="site-assets/css/shortcodes/shortcodes.css" />
...
<!-- <div id="pre-loader">
    <img src="site-assets/images/pre-loader/loader-01.svg" alt="">
</div> -->
     ...
     <div class="container"> 
      <div class="row"> 
       <div class="col-lg-12 col-md-12"> 
        ...
        <ul class="menu-logo">
            <li>
                <a href="index-01.html"><img id="logo_img" src="site-assets/images/logo.png" alt="logo"> </a>
            </li>
        </ul>
        <!-- menu links -->
        <div class="menu-bar">
         ...
         <li class="active"><a href="javascript:void(0)">Home <i class="fa fa-angle-down fa-indicator"></i></a>
                ...
                <div class="drop-down grid-col-12">
                    ...
                    <div class="grid-row">
                        ...
                        <div class="grid-col-3">
                            <ul>
                              <li class="active"><a href="index-01.html">Webster default <span class="label label-warning">default</span> </a></li>
                        ...
                        <div class="grid-col-3">
                            <ul>
                              <li><a href="index-portfolio-01.html">Portfolio Masonry</a></li>
                              <li><a href="index-portfolio-03.html">Portfolio Simple  </a></li>
                              <li><a href="index-portfolio-04.html">Portfolio light <span class="label label-success">New</span> </a></li>
                              <li><a href="index-portfolio-05-dark.html">Portfolio dark <span class="label label-success">New</span> </a></li>
                              ...
                              <li><a href="index-interior-design.html">Interior design </a></li>
                              <li><a href="index-band.html">Band </a></li>
                              <li><a href="index-cafe.html">Cafe </a></li>
                              <li><a href="index-conference.html">Conference <span class="label label-success">New</span> </a></li>
                              <li><a href="index-blog.html">blog <span class="label label-success">New</span> </a></li>
                            </ul>
                        </div>
                        <!--grid column 3-->
                        <div class="grid-col-3">
                            <ul>
                              <li><a href="index-blog-02.html">blog 02 <span class="label label-success">New</span> </a></li>
                              <li><a href="index-blog-boxed.html">blog boxed <span class="label label-success">New</span> </a></li>
                              <li><a href="index-blog-fashion.html">blog fashion <span class="label label-success">New</span> </a></li>
                              <li><a href="index-blog-video.html">blog video <span class="label label-success">New</span> </a></li>
                              <li><a href="index-magazine.html">Magazine <span class="label label-success">New</span> </a></li>
                              <li><a href="index-magazine-02.html">Magazine 02 <span class="label label-success">New</span> </a></li>
                              <li><a href="index-magazine-03.html">Magazine 03 <span class="label label-success">New</span> </a></li>
                              <li><a href="index-mobile-app.html">Mobile app </a></li>
                              <li><a href="index-christmas-landing.html">Christmas Landing <span class="label label-success">New</span> </a></li>
                              <li><a href="one-page-bg-video.html">one page bg video </a></li>
                              <li><a href="one-page-popup-video.html">one page popup video </a></li>
                              <li><a href="one-page-typer.html">one page typer </a></li>
                              <li><a href="one-page-architecture.html">One page architecture <span class="label label-success">New</span> </a></li>
                            </ul>
                        </div>
                        <!--grid column 3-->
                        <div class="grid-col-3">
                          <ul>
                             <li><a href="one-page-agency.html">One page agency  <span class="label label-success">New</span> </a></li>
                             <li><a href="one-page-movie.html">One page movie <span class="label label-success">New</span> </a></li>
                             <li><a href="one-page-law.html">One page Law <span class="label label-success">New</span> </a></li>
                             <li><a href="one-page-agency-02.html">One page Agency 02 <span class="label label-success">New</span> </a></li>
                             <li><a href="one-page-portfolio-parallax.html">Portfolio parallax <span class="label label-success">New</span> </a></li>
                             <li><a href="one-page-book.html">One page book <span class="label label-success">New</span> </a></li>
                             <li><a href="one-page-fish.html">One page fish <span class="label label-success">New</span> </a></li>
                             <li><a href="one-page-hotel.html">One page hotel <span class="label label-success">New</span> </a></li>
                             <li><a href="one-page-pizza.html">One page pizza <span class="label label-success">New</span> </a></li>
                             <li><a href="one-page-plumber.html">One page plumber <span class="label label-success">New</span> </a></li>
                             <li><a href="one-page-product.html">One page product <span class="label label-success">New</span> </a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <li><a href="javascript:void(0)"> Features <i class="fa fa-angle-down fa-indicator"></i></a>
                ...
                <ul class="drop-down-multilevel">
                    ...
                    <li><a href="javascript:void(0)">Side panel<i class="ti-plus fa-indicator"></i></a>
                     <ul class="drop-down-multilevel">
                        <li><a href="side-panel-3d-rotate-in.html">3d rotate in </a></li>
                        <li><a href="side-panel-3d-rotate-out.html">3d rotate out </a></li>
                        <li><a href="side-panel-delayed-3d-rotate.html">delayed 3d rotate </a></li>
                        <li><a href="side-panel-fall-down.html">fall down </a></li>
                        <li><a href="side-panel-in-on-top.html">in on top </a></li>
                        <li><a href="side-panel-open-door.html">open door </a></li>
                        <li><a href="side-panel-push.html">push </a></li>
                        <li><a href="side-panel-reveal.html">reveal </a></li>
                        <li><a href="side-panel-reverse-slide-out.html">reverse slide out </a></li>
                        <li><a href="side-panel-rotate-pusher.html">rotate pusher </a></li>
                        <li><a href="side-panel-scale-down-pusher.html">scale down pusher </a></li>
                        <li><a href="side-panel-scale-rotate-pusher.html">scale rotate pusher </a></li>
                        <li><a href="side-panel-scale-up.html">scale up </a></li>
                        <li><a href="side-panel-slide-along.html">slide along </a></li>
                      </ul>
                    </li>
                    <li><a href="javascript:void(0)">Login & Signup <span class="label label-success">New</span> <i class="ti-plus fa-indicator"></i></a>
                      <ul class="drop-down-multilevel">
                          <li><a href="javascript:void(0)">Login <i class="ti-plus fa-indicator"></i> </a>
                          <!-- drop down second level -->
                          <ul class="drop-down-multilevel">
                              <li><a href="login-01.html">login 01  </a></li>
                              <li><a href="login-02.html">login 02  </a></li>
                              <li><a href="login-03.html">login 03  </a></li>
                              <li><a href="login-04.html">login 04  </a></li>
                              <li><a href="login-05.html">login 05  </a></li>
                              <li><a href="login-06.html">login 06  </a></li>
                              <li><a href="login-07.html">login 07  </a></li>
                              <li><a href="login-08.html">login 08  </a></li>
                              <li><a href="login-09.html">login 09  </a></li>
                              <li><a href="login-10.html">login 10  </a></li>
                              <li><a href="login-11.html">login 11  </a></li>
                              <li><a href="login-12.html">login 12  </a></li>
                              <li><a href="login-13.html">login 13  </a></li>
                              <li><a href="login-14.html">login 14  </a></li>
                              <li><a href="login-15.html">login 15  </a></li>
                          </ul>
                        </li>
                        <li><a href="javascript:void(0)">Signup <i class="ti-plus fa-indicator"></i> </a>
                          <!-- drop down second level -->
                          <ul class="drop-down-multilevel">
                              <li><a href="signup-01.html">signup 01  </a></li>
                              <li><a href="signup-02.html">signup 02  </a></li>
                              <li><a href="signup-03.html">signup 03  </a></li>
                              <li><a href="signup-04.html">signup 04  </a></li>
                              <li><a href="signup-05.html">signup 05  </a></li>
                              <li><a href="signup-06.html">signup 06  </a></li>
                              <li><a href="signup-07.html">signup 07  </a></li>
                              <li><a href="signup-08.html">signup 08  </a></li>
                              <li><a href="signup-09.html">signup 09  </a></li>
                              <li><a href="signup-10.html">signup 10  </a></li>
                              <li><a href="signup-11.html">signup 11  </a></li>
                              <li><a href="signup-12.html">signup 12  </a></li>
                              <li><a href="signup-13.html">signup 13  </a></li>
                              <li><a href="signup-14.html">signup 14  </a></li>
                              <li><a href="signup-15.html">signup 15  </a></li>
                          </ul>
                        </li>
                        <li><a href="login-and-signup.html">login and signup </a></li>
                        <li><a href="login-and-signup-02.html">login and signup 02 </a></li>
                        <li><a href="register-01.html">register 01 </a></li>
                        <li><a href="register-02.html">register 02 </a></li>
                      </ul>
                    </li>
                    <li><a href="javascript:void(0)">Page title<i class="ti-plus fa-indicator"></i></a>
                     <ul class="drop-down-multilevel">
                        ...
                        <li><a href="page-title-small.html"> Title small </a></li>
                        <li><a href="page-title-dark-bg.html"> Title dark-bg </a></li>
                        <li><a href="page-title-light-bg.html"> Title light-bg </a></li>
                        <li><a href="page-title-patten.html"> Title patten </a></li>
                        <li><a href="page-title-parallax.html"> Title parallax </a></li>
                        <li><a href="page-title-html-video.html"> Title html video </a></li>
                        <li><a href="page-title-vimeo-video.html"> Title vimeo video </a></li>
                        <li><a href="page-title-youtube-video.html"> Title youtube video </a></li>
                        <li><a href="page-title-light-overlay.html"> Title light overlay <span class="label label-success">New</span> </a> </li>
                      </ul>
                    </li>

                    <li><a href="javascript:void(0)">Coming soon  <span class="label label-success">New</span> <i class="ti-plus fa-indicator"></i></a>
                     <ul class="drop-down-multilevel">
                        <li><a href="coming-soon-01.html">Coming soon 01  </a></li>
                        <li><a href="coming-soon-02.html">Coming soon 02  </a></li>
                        <li><a href="coming-soon-03.html">Coming soon 03  </a></li>
                        <li><a href="coming-soon-04.html">Coming soon 04 </a></li>
                        <li><a href="coming-soon-04.html">Coming soon 04 </a></li>
                        <li><a href="coming-soon-05.html">Coming soon 05 </a></li>
                        <li><a href="coming-soon-06.html">Coming soon 06 </a></li>
                        <li><a href="coming-soon-07.html">Coming soon 07 </a></li>
                        <li><a href="coming-soon-08.html">Coming soon 08 </a></li>
                        <li><a href="coming-soon-09.html">Coming soon 09 </a></li>
                        <li><a href="coming-soon-10.html">Coming soon 10 </a></li>
                        <li><a href="coming-soon-11.html">Coming soon 11 </a></li>
                        <li><a href="coming-soon-12.html">Coming soon 12 </a></li>
                      </ul>
                    </li>
                    <li><a href="javascript:void(0)">Error 404 <span class="label label-success">New</span> <i class="ti-plus fa-indicator"></i></a>
                     <ul class="drop-down-multilevel">
                        <li><a href="error-404-01.html">error 404 01 </a></li>
                        <li><a href="error-404-02.html">error 404 02 </a></li>
                        <li><a href="error-404-03.html">error 404 03 </a></li>
                        <li><a href="error-404-04.html">error 404 04 </a></li>
                        <li><a href="error-404-05.html">error 404 05 </a></li>
                        <li><a href="error-404-06.html">error 404 06 </a></li>
                        <li><a href="error-404-07.html">error 404 07 </a></li>
                        <li><a href="error-404-08.html">error 404 08 </a></li>
                        <li><a href="error-404-09.html">error 404 09 </a></li>
                      </ul>
                    </li>
                    <li><a href="javascript:void(0)">Modal onload<i class="ti-plus fa-indicator"></i></a>
                     <ul class="drop-down-multilevel">
                        <li><a href="modal-onload-login.html">login </a></li>
                        <li><a href="modal-onload-register.html">register </a></li>
                        <li><a href="modal-onload-shop.html">shop </a></li>
                        <li><a href="modal-onload-subscribe.html">subscribe </a></li>
                        <li><a href="modal-onload-text.html">text </a></li>
                        <li><a href="modal-onload-video.html">video </a></li>
                      </ul>
                    </li>
                    ...
                    <li><a href="javascript:void(0)">Contact us<i class="ti-plus fa-indicator"></i></a>
                     <ul class="drop-down-multilevel">
                    ...
                    <li><a href="pre-loader.html">Pre loader </a></li>
                </ul>
            </li>
                    ...
                    <div class="grid-row">
                        ...
                        <div class="grid-col-3">
                            <ul>
                              ...
                              <li><a href="about-03.html">About 03</a></li>
                              <li><a href="about-04.html">About 04 <span class="label label-success">New</span> </a></li>
                              <li><a href="about-05.html">About 05 <span class="label label-success">New</span> </a></li>
                              <li><a href="about-06.html">About 06 <span class="label label-success">New</span> </a></li>
                              <li><a href="about-me.html">About me</a></li>
                              <li><a href="about-me-02.html">About me 02 <span class="label label-success">New</span> </a></li>
                              <li><a href="about-ceo.html">About ceo <span class="label label-success">New</span> </a></li>
                              <li><a href="about-team.html">About team <span class="label label-success">New</span> </a></li>
                            </ul>
                        </div>
                        <!--grid column 3-->
                        <div class="grid-col-3">
                            <ul>
                              <li><a href="about-our-mission.html">About our mission <span class="label label-success">New</span> </a></li>
                              <li><a href="service-01.html">service 01 </a></li>
                              <li><a href="service-02.html">service 02 </a></li>
                              <li><a href="service-03.html">service 03 </a></li>
                              <li><a href="team-01.html">team 01 </a></li>
                              <li><a href="team-02.html">team 02 </a></li>
                              <li><a href="team-03.html">team 03 <span class="label label-success">New</span> </a></li>
                        ...
                        <div class="grid-col-3">
                            <ul>
                              <li><a href="contact-03.html">contact 03 </a></li>
                              <li><a href="faqs-01.html">faqs 01 </a></li>
                              <li><a href="faqs-02.html">faqs 02 </a></li>
                              <li><a href="faqs-03.html">faqs 03 <span class="label label-success">New</span> </a></li>
                              <li><a href="faqs-04.html">faqs 04  <span class="label label-success">New</span></a></li>
                              <li><a href="our-clients-01.html">our clients 01 </a></li>
                              <li><a href="our-clients-02.html">our clients 02 </a></li>
                        ...
                        <div class="grid-col-3">
                            <ul>
                               <li><a href="maintenance-01.html">maintenance 01 </a></li>
                              <li><a href="maintenance-02.html">maintenance 02 </a></li>
            ...
            <li><a href="javascript:void(0)">blog <i class="fa fa-angle-down fa-indicator"></i></a>
                <!-- drop down multilevel  -->
                <ul class="drop-down-multilevel">
                    <li><a href="javascript:void(0)">blog classic <i class="ti-plus fa-indicator"></i> </a>
                    ...
                    <li><a href="javascript:void(0)">grid <i class="ti-plus fa-indicator"></i> </a>
                        <!-- drop down second level -->
                        <ul class="drop-down-multilevel">
                    ...
                    <li><a href="javascript:void(0)">Masonry  <i class="ti-plus fa-indicator"></i> </a>
                      <!-- drop down second level -->
                        <ul class="drop-down-multilevel">
                    ...
                    <li><a href="#">timeline  <i class="ti-plus fa-indicator"></i></a>
                        <!-- drop down second level -->
                        <ul class="drop-down-multilevel">
                    ...
                    <li><a href="#">single post  <i class="ti-plus fa-indicator"></i></a>
                        <!-- drop down second level -->
                        <ul class="drop-down-multilevel">
                            <li><a href="blog-single-audio-post.html"> audio post  </a> </li>
                            <li><a href="blog-single-grid-post.html"> grid post  </a> </li>
                            <li><a href="blog-single-HTML5-video-post.html"> HTML5 video post  </a> </li>
                            <li><a href="blog-single-image-post.html"> image post  </a> </li>
                            <li><a href="blog-single-slider-post.html"> slider post  </a> </li>
                            <li><a href="blog-single-soundcloud.html"> soundcloud  </a> </li>
                            <li><a href="blog-single-vimeo-post.html"> vimeo post  </a> </li>
                            <li><a href="blog-single-without-Image-post.html"> without Image post  </a> </li>
            ...
            <li><a href="javascript:void(0)">Portfolio<i class="fa fa-angle-down fa-indicator"></i></a>
                ...
                <ul class="drop-down-multilevel left-side">
                    ...
                    <li><a href="#">portfolio classic <i class="ti-plus fa-indicator"></i></a>
                      <!-- drop down second level -->
                        <ul class="drop-down-multilevel left-side">
                            <li><a href="javascript:void(0)"> 1 column  <i class="ti-plus fa-indicator"></i></a>
                            ...
                            <li><a href="javascript:void(0)"> 2 column  <i class="ti-plus fa-indicator"></i></a>
                                <!-- drop down third level -->
                                <ul class="drop-down-multilevel left-side">
                            ...
                            <li><a href="javascript:void(0)"> 3 column  <i class="ti-plus fa-indicator"></i></a>
                                <!-- drop down third level -->
                                <ul class="drop-down-multilevel left-side">
                            ...
                            <li><a href="javascript:void(0)"> 4 column <i class="ti-plus fa-indicator"></i></a>
                                <!-- drop down third level -->
                                <ul class="drop-down-multilevel left-side">
                    ...
                    <li><a href="javascript:void(0)">portfolio Masonry <i class="ti-plus fa-indicator"></i></a>
                      <!-- drop down second level -->
                        <ul class="drop-down-multilevel left-side">
                    ...
                    <li><a href="#">portfolio grid <i class="ti-plus fa-indicator"></i></a>
                      <ul class="drop-down-multilevel left-side">
                            <li><a href="javascript:void(0)"> grid <i class="ti-plus fa-indicator"></i></a>  
                               <!-- drop down third level -->
                                <ul class="drop-down-multilevel left-side">
                            ...
                            <li><a href="javascript:void(0)"> grid full screen <i class="ti-plus fa-indicator"></i></a> 
                               <!-- drop down third level -->
                                <ul class="drop-down-multilevel left-side">
                    ...
                    <li><a href="#">portfolio about <i class="ti-plus fa-indicator"></i></a>
                      <!-- drop down second level -->
                        <ul class="drop-down-multilevel left-side">
                            <li><a href="portfolio-04-about.html"> portfolio 04 about </a> </li>
                            <li><a href="portfolio-05-about-dark.html"> portfolio 05 about dark </a> </li>
                         </ul>
                    </li>
                    <li><a href="#">portfolio single <i class="ti-plus fa-indicator"></i></a>
                      <!-- drop down second level -->
                        <ul class="drop-down-multilevel left-side">
                            <li><a href="portfolio-single-01.html"> single 01 </a> </li>
                            <li><a href="portfolio-single-02.html"> single 02 </a> </li>
                            <li><a href="portfolio-04-single.html"> portfolio 04 single </a> </li>
                            <li><a href="portfolio-05-single-dark.html"> portfolio 05 single dark </a> </li>
                         </ul>
                    </li>
                </ul>
            </li>
               ...
               <div class="grid-row">
                 <!--grid column 3-->
                  <div class="grid-col-6">
                   <ul>
                     <li><a href="shop-home-01.html">shop Fashion </a></li>
                     <li><a href="shop-home-02.html">Trendy Shop</a></li>
                     <li><a href="shop-home-03.html">LookBook</a></li>
                     <li><a href="shop-home-04.html">Shop Morden <span class="label label-success">New</span> </a></li>
                     <li><a href="shop-home-05.html">Shop Creative <span class="label label-success">New</span> </a></li>
                     <li><a href="shop-home-06.html">Minimal <span class="label label-success">New</span> </a></li>
                     <li><a href="shop-home-07.html">Classic Shop <span class="label label-success">New</span> </a></li>
                     <li><a href="shop-home-08.html">Shop simple <span class="label label-success">New</span> </a></li>
                   </ul>
                  </div>
                  <div class="grid-col-6">
                   <ul>
                     ...
                     <li><a href="shop-single-02.html">Shop single 02 <span class="label label-success">New</span> </a></li>
                     <li><a href="shop-checkout.html">Shop checkout <span class="label label-success">New</span> </a></li>
                     <li><a href="shop-shopping-cart.html">Shop shopping cart <span class="label label-success">New</span> </a></li>
                     <li><a href="shop-wishlist.html">Shop wishlist <span class="label label-success">New</span> </a></li>
                   </ul>
                  </div>
                 </div>
                </div>
 ...
 <section class="rev-slider">
  ...
  <!-- START REVOLUTION SLIDER 5.4.5.2 fullwidth mode -->
   <div id="rev_slider_11_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.5.2">
     <ul>  <!-- SLIDE  -->
        <li data-index="rs-24" data-transition="random-static,random-premium,random" data-slotamount="default,default,default,default" data-hideafterloop="0" data-hideslideonmobile="off"  data-randomtransition="on" data-easein="default,default,default,default" data-easeout="default,default,default,default" data-masterspeed="default,default,default,default"  data-thumb="site-assets/revolution/assets/slider-01/70x70_1a353-01.jpg"  data-rotate="0,0,0,0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
        <!-- MAIN IMAGE -->
            <img src="site-assets/revolution/assets/slider-01/1a353-01.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
        <!-- LAYERS -->
        <!-- LAYER NR. 1 -->
        <div class="tp-caption   tp-resizeme" 
           ...
           style="z-index: 5; white-space: nowrap; font-size: 40px; line-height: 40px; font-weight: 200; color: rgba(255,255,255,1); letter-spacing: px;font-family:Montserrat ;">Welcome to the world  of <br/>extraordinary Html5 template </div>
        <!-- LAYER NR. 2 -->
        <div class="tp-caption   tp-resizeme  rev-color" 
          ...
          data-paddingbottom="[0,0,0,0]"
          data-paddingleft="[0,0,0,0]"
          style="z-index: 6; white-space: nowrap; font-size: 150px; line-height: 150px; font-weight: 600; color: #84ba3f; letter-spacing: px;font-family:Dosis;">webster </div>
        <!-- LAYER NR. 3 -->
        <div class="tp-caption   tp-resizeme" 
           id="slide-24-layer-5" 
           ...
           data-paddingbottom="[0,0,0,0]"
           data-paddingleft="[0,0,0,0]"
           style="z-index: 7; white-space: nowrap; font-size: 20px; line-height: 22px; font-weight: 600; color: rgba(255,255,255,1); letter-spacing: px;font-family:Montserrat ;text-transform:uppercase;"><i class="fa-icon-check"></i> Versatile  &nbsp; &nbsp;&nbsp; | </div>
        <!-- LAYER NR. 4 -->
        <div class="tp-caption   tp-resizeme" 
           id="slide-24-layer-7" 
           ...
           data-paddingbottom="[0,0,0,0]"
           data-paddingleft="[0,0,0,0]"
           style="z-index: 8; white-space: nowrap; font-size: 20px; line-height: 22px; font-weight: 600; color: rgba(255,255,255,1); letter-spacing: px;font-family:Montserrat ;text-transform:uppercase;"><i class="fa-icon-check"></i> Super Fast  &nbsp; &nbsp;&nbsp; | </div>
        <!-- LAYER NR. 5 -->
        <div class="tp-caption   tp-resizeme" 
           id="slide-24-layer-8" 
           ...
           data-paddingbottom="[0,0,0,0]"
           data-paddingleft="[0,0,0,0]"
           style="z-index: 9; white-space: nowrap; font-size: 20px; line-height: 22px; font-weight: 600; color: rgba(255,255,255,1); letter-spacing: px;font-family:Montserrat ;text-transform:uppercase;"><i class="fa-icon-check"></i> Creative  &nbsp; &nbsp;&nbsp; | </div>
        ...
        <div class="tp-caption   tp-resizeme" 
           ...
           data-paddingbottom="[0,0,0,0]"
           data-paddingleft="[0,0,0,0]"
           style="z-index: 10; white-space: nowrap; font-size: 20px; line-height: 22px; font-weight: 600; color: rgba(255,255,255,1); letter-spacing: ;font-family:Montserrat ;text-transform:uppercase;"><i class="fa-icon-check"></i> Modern  &nbsp; &nbsp;&nbsp; | </div>
        <!-- LAYER NR. 7 -->
        <div class="tp-caption   tp-resizeme" 
           ...
           data-paddingbottom="[0,0,0,0]"
           data-paddingleft="[0,0,0,0]"
           style="z-index: 11; white-space: nowrap; font-size: 20px; line-height: 22px; font-weight: 600; color: rgba(255,255,255,1); letter-spacing: ;font-family:Montserrat ;text-transform:uppercase;"><i class="fa-icon-check"></i> Elegant </div>
        <!-- LAYER NR. 8 -->
        <div class="tp-caption rev-btn  tp-resizeme  rev-button" 
           ...
           style="z-index: 12; white-space: nowrap; font-size: 12px; line-height: 22px; font-weight: 600; color: rgba(255,255,255,1); letter-spacing: px;font-family:Montserrat ;text-transform:uppercase;background-color:rgb(132,186,63);border-color:rgba(0,0,0,1);border-radius:30px 30px 30px 30px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;">Purchase Now </div>
      </li>
      <!-- SLIDE  -->
        <li data-index="rs-23" data-transition="random-static,random-premium,random" data-slotamount="default,default,default,default" data-hideafterloop="0" data-hideslideonmobile="off"  data-randomtransition="on" data-easein="default,default,default,default" data-easeout="default,default,default,default" data-masterspeed="default,default,default,default"  data-thumb="site-assets/revolution/assets/slider-01/70x70_02483-02.jpg"  data-rotate="0,0,0,0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
        <!-- MAIN IMAGE -->
            <img src="site-assets/revolution/assets/slider-01/02483-02.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
        <!-- LAYERS -->
        <!-- LAYER NR. 9 -->
        <div class="tp-caption   tp-resizeme" 
           id="slide-23-layer-2" 
        ...
        <div class="tp-caption   tp-resizeme" 
           ...
           data-paddingbottom="[0,0,0,0]"
           data-paddingleft="[0,0,0,0]"
           style="z-index: 6; white-space: nowrap; font-size: 60px; line-height: 70px; font-weight: 400; color: rgba(255,255,255,1); letter-spacing: px;font-family:Montserrat ;">Just Change the <strong>Future</strong>? </div>
        ...
        <div class="tp-caption   tp-resizeme" 
           ...
           data-paddingbottom="[0,0,0,0]"
           data-paddingleft="[0,0,0,0]"
           style="z-index: 7; white-space: nowrap; font-size: 24px; line-height: 28px; font-weight: 200; color: rgba(255,255,255,1); letter-spacing: px;font-family: Montserrat ;">In today′s world, the importance of a well-executed web presence
        ...
        <div class="tp-caption rev-btn  tp-resizeme" 
           ...
           data-paddingleft="[30,30,30,30]"
           style="z-index: 9; white-space: nowrap; font-size: 12px; line-height: 22px; font-weight: 600; color: rgba(255,255,255,1); letter-spacing: px;font-family:Montserrat ;text-transform:uppercase;background-color:rgba(0,0,0,0);border-color:rgb(255,255,255);border-style:solid;border-width:2px 2px 2px 2px;border-radius:30px 30px 30px 30px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;">purchase Now </div>
      </li>
    </ul>
     ...
     <div class="row">
      <div class="col-lg-4 col-md-4 col-sm-4 xs-mb-30">
        <div class="feature-box">
          ...
          <a href="#">Read more</a>
          <div class="feature-box-img" style="background-image: url('site-assets/images/about/01.jpg');"></div>
      ...
      <div class="col-lg-4 col-md-4 col-sm-4 xs-mb-30">
        <div class="feature-box active">
          ...
          <p>Responsive and Flexible layout. This allows the web page to stretch and contract relative to the user's screen size.</p>
          </div>
          <a href="#">Read more</a>
          <div class="feature-box-img" style="background-image: url('site-assets/images/about/02.jpg');"></div>
          <span class="border"></span>
        </div>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-4">
        <div class="feature-box">
          ...
          <a href="#">Read more</a>
          <div class="feature-box-img" style="background-image: url('site-assets/images/about/03.jpg');"></div>
          <span class="border"></span>
        </div>
      </div>
     </div>
   ...
   <div class="side-background">
        <div class="col-md-5 img-side img-left visible-md visible-lg">
            <div class="row page-section-pt mt-30">
              <img src="site-assets/images/objects/07.png" alt="">
            </div>
        </div>
    </div>
   <div class="container">
   ...
   <div class="row">
     <div class="col-lg-6 col-md-6 sm-mb-30">
       <div class="owl-carousel bottom-left-dots" data-nav-dots="ture" data-items="1" data-md-items="1" data-sm-items="1" data-xs-items="1" data-xx-items="1">
         <div class="item">
            <img class="img-responsive" src="site-assets/images/about/01.jpg" alt="">
          </div>
          <div class="item">
            <img class="img-responsive" src="site-assets/images/about/02.jpg" alt="">
          </div>
          <div class="item">
            <img class="img-responsive" src="site-assets/images/about/03.jpg" alt="">
          </div>
      </div>
     </div>
     <div class="col-lg-6 col-md-6">
       ...
       <div class="mt-30">
       <a class="button icon mb-10 mr-10" data-toggle="modal" data-target="#myModal" href="#">
        <span>View modal popup</span>
        <i class="fa fa-eye"></i>
       </a>
        <!-- Modal -->
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <div class="section-title mb-10">
                  <h6>Hello!</h6>
                  <h2>Modal title</h2>
                  <p>You can use model anywhere in your website. Simply add model HTML code where you want this popup model.</p>
                </div>
              </div>
              <div class="modal-body">
              <span class="dropcap square">W</span>e are an innovative agency. We develop and design customers around the world. Our clients are some of the most forward-looking companies in the world.consectetur adipisicing elit. At vel sed corporis delectus quo ea molestias a ab ad officiis eaque natus animi reiciendis sint beatae dolor inventore praesentium lorem qui.
              </div>
      ...
      <a class="button border icon" href="#">
...
<section class="our-service-home page-section-ptb bg-overlay-black-90 parallax" data-jarallax='{"speed": 0.6}' style="background-image: url(site-assets/images/bg/06.jpg);">
 <div class="container">
  <div class="row mb-60">
      <div class="col-lg-8 col-md-8">
        <div class="section-title">
  ...
  <div class="custom-content">
     ...
     <div class="col-lg-3 col-md-3">
          <div class="popup-video">
            <img class="img-responsive full-width" src="site-assets/images/about/01.jpg" alt="">
        ...
        <div class="col-lg-9 col-md-9">
          <h5 class="text-white">We develop and design customers around the world</h5>
            <div class="row">
               <div class="col-lg-6 col-md-6 col-sm-6">
                  ...
                  <div class="feature-info">
                    <h5 class="text-white">Many Style Available</h5>
                    <p class="text-white">Consectetur dolor sit conseqt quibusdam, enim expedita sed quia nesciunt</p>
                  </div>
                </div>
               </div>
               <div class="col-lg-6 col-md-6 col-sm-6">
                  <div class="feature-text left-icon mt-30">
                    ...
                    <div class="feature-info">
                      <h5 class="text-white">Parallax Sections</h5>
         ...
         <div class="isotope popup-gallery columns-3 no-padding">
            <div class="grid-item">
              <div class="portfolio-item">
                 <img src="site-assets/images/portfolio/small/01.jpg" alt="">
             ...
             <div class="grid-item">
              <div class="portfolio-item">
                 <img src="site-assets/images/portfolio/small/02.jpg" alt="">
                  <div class="portfolio-overlay">
                      <h4 class="text-white"> <a href="portfolio-single-01.html"> Post item image</a> </h4>
                      <span class="text-white"> <a href="#"> Photography  </a>| <a href="#">Illustration </a> </span>            
                 </div>
             ...
             <div class="grid-item">
              <div class="portfolio-item">
                 <img src="site-assets/images/portfolio/small/03.jpg" alt="">
                  <div class="portfolio-overlay">
                      <h4 class="text-white"> <a href="portfolio-single-01.html"> Post item image</a> </h4>
                      <span class="text-white"> <a href="#"> Photography  </a>| <a href="#">Illustration </a> </span>            
                 </div>
             ...
             <div class="grid-item">
              <div class="portfolio-item">
                 <img src="site-assets/images/portfolio/small/04.gif" alt="">
                  <div class="portfolio-overlay">
             ...
             <div class="grid-item">
              <div class="portfolio-item">
                 <img src="site-assets/images/portfolio/small/05.jpg" alt="">
                  <div class="portfolio-overlay">
                      <h4 class="text-white"> <a href="portfolio-single-01.html"> Post item image</a> </h4>
                      <span class="text-white"> <a href="#"> Photography  </a>| <a href="#">Illustration </a> </span>            
                 </div>
             ...
             <div class="grid-item">
              <div class="portfolio-item">
                 <img src="site-assets/images/portfolio/small/06.jpg" alt="">
                  <div class="portfolio-overlay">
                      <h4 class="text-white"> <a href="portfolio-single-01.html"> Post item image </a> </h4>
                      <span class="text-white"> <a href="#"> Photography  </a>| <a href="#">Illustration </a> </span>            
                 </div>
             ...
             <div class="pricing-content">
               <div class="pricing-table-list">
                    <ul class="list-unstyled">
                        <li> <i class="fa fa-check"></i> 25 Analytics Campaign <span class="tooltip-content pull-right" data-placement="top" data-toggle="tooltip" data-original-title="Lorem ipsum dolor sit amet"><i class="fa fa-info"></i></span></li>
                        <li><i class="fa fa-times"></i> Branded Reports <span class="tooltip-content pull-right" data-placement="top" data-toggle="tooltip" data-original-title="Lorem ipsum dolor sit amet"><i class="fa fa-info"></i></span> </li>
                        <li><i class="fa fa-check"></i> 1,900 Keywords <span class="tooltip-content pull-right" data-placement="top" data-toggle="tooltip" data-original-title="Lorem ipsum dolor sit amet"><i class="fa fa-info"></i></span> </li>
                        <li> <i class="fa fa-times"></i> 4 Social Account <span class="tooltip-content pull-right" data-placement="top" data-toggle="tooltip" data-original-title="Lorem ipsum dolor sit amet"><i class="fa fa-info"></i></span> </li>
                        <li> <i class="fa fa-times"></i>  Phone & Email Support <span class="tooltip-content pull-right" data-placement="top" data-toggle="tooltip" data-original-title="Lorem ipsum dolor sit amet"><i class="fa fa-info"></i></span> </li>
                    </ul>
                </div>
             </div>
          </div>
            ...
            <div class="pricing-table active">
             ...
             <div class="pricing-content">
               <div class="pricing-table-list">
                    <ul class="list-unstyled">
                        <li> <i class="fa fa-check"></i> 25 Analytics Campaign <span class="tooltip-content pull-right" data-placement="top" data-toggle="tooltip" data-original-title="Lorem ipsum dolor sit amet"><i class="fa fa-info"></i></span></li>
                        <li><i class="fa fa-check"></i> Branded Reports <span class="tooltip-content pull-right" data-placement="top" data-toggle="tooltip" data-original-title="Lorem ipsum dolor sit amet"><i class="fa fa-info"></i></span> </li>
                        <li><i class="fa fa-check"></i> 1,900 Keywords <span class="tooltip-content pull-right" data-placement="top" data-toggle="tooltip" data-original-title="Lorem ipsum dolor sit amet"><i class="fa fa-info"></i></span> </li>
                        <li> <i class="fa fa-check"></i> 4 Social Account <span class="tooltip-content pull-right" data-placement="top" data-toggle="tooltip" data-original-title="Lorem ipsum dolor sit amet"><i class="fa fa-info"></i></span> </li>
                        <li> <i class="fa fa-check"></i>  Phone & Email Support <span class="tooltip-content pull-right" data-placement="top" data-toggle="tooltip" data-original-title="Lorem ipsum dolor sit amet"><i class="fa fa-info"></i></span> </li>
                    </ul>
                </div>
             </div>
          </div> 
...
<section class="gray-bg page-section-pt happy-clients">
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6">
           <img class="hidden-sm hidden-xs img-responsive" src="site-assets/images/objects/testimonial.png" alt="">
      </div>
       ...
       <div class="tab-pane fade in active" id="testi-01"> 
        ...
        <div class="tab-pane fade" id="testi-04"> 
         ...
         <ul class="nav nav-tabs mt-60">
           <li class="active"><a href="#testi-01" data-toggle="tab"><img class="img-responsive" src="site-assets/images/team/01.jpg" alt=""> </a></li>
           <li><a href="#testi-02" data-toggle="tab"><img class="img-responsive" src="site-assets/images/team/02.jpg" alt=""> </a></li>
           <li><a href="#testi-03" data-toggle="tab"><img class="img-responsive" src="site-assets/images/team/03.jpg" alt=""> </a></li>
           <li><a href="#testi-04" data-toggle="tab"><img class="img-responsive" src="site-assets/images/team/04.jpg" alt=""> </a></li>
          </ul>
       </div>
     </div>
    </div>  
     ...
     <div class="col-lg-4 col-md-4 col-sm-4">
        <div class="blog-box  blog-1">        
         <div class="blog-info">
          ...
          <div class="blog-box-img" style="background-image:url(site-assets/images/blog/01.jpg);"></div>
     ...
     <div class="col-lg-4 col-md-4 col-sm-4">
        <div class="blog-box blog-1 active">        
         <div class="blog-info">
          ...
          <div class="blog-box-img" style="background-image:url(site-assets/images/blog/09.jpg);"></div>
        </div>
        </div>
     <div class="col-lg-4 col-md-4 col-sm-4">
        <div class="blog-box blog-1">
          ...
          <div class="blog-box-img" style="background-image:url(site-assets/images/blog/03.jpg);"></div>
        </div>
      </div>
     </div>
    </div>
...
<!-- jquery -->
<script type="text/javascript" src="site-assets/js/jquery-1.12.4.min.js"></script>

<!-- plugins-jquery -->
<script type="text/javascript" src="site-assets/js/plugins-jquery.js"></script>
...
<!-- revolution custom --> 
<script type="text/javascript" src="site-assets/revolution/js/revolution-custom.js"></script> 
