            ...
            <div class="row pt-20 pb-40">
                ...
                <div class="col-lg-4 col-sm-4">
                    <div class="contact-box">
                        ...
                        <div class="contact-info">
                            <h5 class="text-white">info@teamnhyira.com</h5>
...
<footer class="footer  black-bg">
 <div class="container">
      ...
      <div class="footer-widget mt-20" style="border-top:none;">
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-6 xs-mb-20">
           <p class="mt-15"> &copy;Copyright <span id="copyright"> <script>document.getElementById('copyright').appendChild(document.createTextNode(new Date().getFullYear()))</script></span> <a href="#"> Team Nhyira </a> All Rights Reserved </p>
          </div>
